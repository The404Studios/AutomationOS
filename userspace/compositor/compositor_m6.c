...
static int32_t work_x1(void)        { return (int32_t)g_fb_w - WORK_MARGIN; }
...
/* ====================================================================== */
void _start(void) {
    print("[SHELL] M6 window-manager desktop shell starting\n");
    ...
    /* M6: welcome notification toast (fade-in/hold/fade-out over ~3.5s). */
    toast_show("Welcome to AutomationOS", 3500);
